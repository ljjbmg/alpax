...
±±ºPrograma  ³FCVEN415  ºAutor  ³Adriano Luis Brandaoº Data ³  13/10/04   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Funcao para consultar as ultimas vendas do cliente e produtoº±±
±±º          ³selecionado no pedido de vendas.                            º±±
