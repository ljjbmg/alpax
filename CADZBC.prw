...
±±ºPrograma  ³NOVO5     º Autor ³ AP6 IDE            º Data ³  15/10/12   º±±
...
Private cCadastro := "CAIXA X SEPARAÇÃO"
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
Private aRotina := { {"Pesquisar","AxPesqui",0,1} ,;
             ...
             {"Alterar","AxAltera",0,4} ,;
             {"Excluir","AxDeleta",0,5} ,;
             {"Legenda","U_ZBCLEG",0,5} }

PRIVATE aCORES    := { 	{"ZBC_STATUS == '1'" ,"BR_VERMELHO" } ,; 	// SEPARADO
						{"ZBC_STATUS == '2'" ,"BR_VERDE" 	} }   	// EXPEDIDO
...
USER FUNCTION ZBCLEG()

LOCAL _aLEGENDA := {}

	AADD( _aLEGENDA, {"BR_VERMELHO"   	,"SEPARADO"		} )	
	AADD( _aLEGENDA, {"BR_VERDE"		,"EXPEDIDO"		} )	
