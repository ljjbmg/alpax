...
±±ºPrograma  ³FCPROD415 ºAutor  ³Adriano Luis Brandaoº Data ³  13/10/04   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Funcao para consultar os pedidos de compras em aberto do    º±±
±±º          ³produto selecionado no pedido de vendas.                    º±±
