...
ฑฑบPrograma  ณRELVM02   บ Autor ณFAGNER / BIALE      บ Data ณ  28/12/09   บฑฑB
ฑฑบUso       ณ ALPAX                                                      บฑฑ
...
Local cDesc3       := "Relat๓rio de Controle de Laborat๓rio"
Local cPict        := ""
Local titulo       := "Relat๓rio de Controle de Envio de Material ao Laborat๓rio"
Local nLin         := 80
...
Local Cabec1       := "P.NUMBER             CODIGO           DESCRIวรO                                           MARCA           CAPACIDADE          QTDE."
Local Cabec2       := ""
Local imprime      := .T.
Local aOrd 		   := {}
Private lEnd       := .F.
